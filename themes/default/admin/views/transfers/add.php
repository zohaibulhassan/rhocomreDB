...
//    var a =  localStorage.getItem('toitems');
// var parsedObject = JSON.parse(a);
// var quantity = parsedObject["65f6dbc1e0fe6387cb1f18447f5813839f1dc25a"].row.qty;
                        ...
                        <?php if ($Owner || $Admin) { ?>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?= lang("date", "todate"); ?>
                                    <input type="text" name="date" class="form-control input-tip" value="<?php echo date("d-m-Y h:i:s") ?>" required >
                                    <?php //echo form_input('date', (isset($_POST['date']) ? $_POST['date'] : ""), 'class="form-control input-tip date"  required="required" id="todate"'); ?>                                    
                                </div>
                            </div>
                        <?php } ?>
                        <div class="col-md-4">
                            ...
                            <?php if ($Owner || $Admin || !$this->session->userdata('suppliers_id')) { ?>
                                    <div class="form-group">
                                        ...
                                        foreach ($suppliers as $supplier) {
                                            $oc[$supplier->id] = $supplier->name;
                                        }
                                        echo form_dropdown('supplier', $oc, (isset($_POST['supplier']) ? $_POST['supplier'] : $Settings->default_warehouse), 'id="posupplier" class="form-control input-tip select" data-placeholder="' . lang("select") . ' ' . lang("supplier") . '" required="required" style="width:100%;" ');
                                        ?>
                                    </div>
                            <?php } else {
