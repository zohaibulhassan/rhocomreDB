                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="start_date" value="<?php echo $start ?>" class="form-control" id="start_date">
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <?= lang("end_date", "end_date"); ?>
                                    <input type="date" name="end_date" value="<?php echo $end ?>" class="form-control" id="end_date">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
