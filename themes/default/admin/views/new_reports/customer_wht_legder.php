...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-barcode"></i>Customer WHT Ledger</h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div>
                    <form action="<?= admin_url('reports/customer_wht_legder') ?>" method="get">
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="supplier" class="form-control searching_select" id="customerID" data-placeholder="Select Supplier" required="required">
                                        ...
                                        ?>
                                            <option value="<?php echo $row->id ?>" <?php if ($row->id == $supplier_id) {
                                                                                        echo 'selected';
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="customer" class="form-control searching_select" id="customerID" data-placeholder="Select Customer" required="required">
                                        ...
                                        ?>
                                            <option value="<?php echo $row->id ?>" <?php if ($row->id == $customer_id) {
                                                                                        echo 'selected';
                                                                                    } ?>><?php echo $row->name ?></option>
                                        <?php
                                        }
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="company" id="companyID" class="form-control input-tip searching_select " data-placeholder="Select Companies" style="width:100%;">
                                        ...
                                        ?>
                                            <option value="<?php echo $row->id ?>" <?php if ($row->id == $company_id) {
                                                                                        echo 'selected';
                                                                                    } ?>><?php echo $row->name ?></option>
                                        <?php
                                        }
