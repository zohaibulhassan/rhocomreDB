                        ...
                        <table class="table table-bordered table-hover table-striped">
                            ...
                            <tbody>
                                ...
                                foreach ($rows as $row) :
                                    ...
                                    $further_tax = (($row->tax_type == 2) ? "" : (($unit_price_show * 4) / 100) * $row->unit_quantity);
                                    ...
                                    $my_row_subtotal = $this->sma->formatDecimal(($four * $row->unit_quantity) + $row->adv_tax);
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <?php } ?>
                                        <td style="text-align:center; width:90px;vertical-align:middle; width:20px; "><?php echo $row->adv_tax; ?></td>
                                        ...
                                        <div class="divTable">
                                            <div class="divTableBody">
                                                ...
                                                <div class="divTableRow">
                                                    ...
                                                    <div class="divTableCell"><?php echo $this->sma->formatMoney($total_adv_tax); ?></div>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- DivTable.com -->
                                        ...
                                        <div class="divTable">
                                            <div class="divTableBody">
                                                ...
                                                <div class="divTableRow">
                                                    ...
                                                    <div class="divTableCell"><?php echo $this->sma->formatMoney(($net_amount + $total_adv_tax) - $total_discount_one - $total_discount_three); ?></div>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- DivTable.com -->
