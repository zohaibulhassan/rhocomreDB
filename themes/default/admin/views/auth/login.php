...
<head>
    ...
    <link rel="icon" type="image/png" href="<?php echo base_url('themes/v1/assets/img/favicon-16x16.png'); ?>"
        sizes="16x16">
    <title>
        <?php echo $title; ?>
    </title>
    ...
    <link rel="stylesheet"
        href="<?php echo base_url('themes/v1/assets/bower_components/uikit/css/uikit.almost-flat.min.css'); ?>" />
        ...
        <div class="md-card" id="login_card">
            <div class="md-card-content large-padding" id="login_form">
                <div class="login_heading">
                    <img src="<?php echo base_url('assets/images/300_X_80_Rho_Com_360_.png'); ?>" id="logoimg"
                        alt="<?php $Settings->site_name; ?>">
                </div>
                ...
                <?php if ($showEncryptionKey) { ?>
                    <div class="uk-form-row">
                        <label for="login_password">Encryption Key</label>
                        <input class="md-input" required type="text" name="key" />
                    </div>
                <?php } ?>
                ...
                <div class="uk-margin-top">
                    ...
                    <span class="icheck-inline">
                        ...
                        <label for="login_page_stay_signed" class="inline-label">
