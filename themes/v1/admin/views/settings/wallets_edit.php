                    ...
                    <div class="uk-grid">
                        <div class="uk-width-large-1-3">
                            <div class="md-input-wrapper md-input-filled">
                                ...
                                <input type="text" name="title" class="md-input md-input-success label-fixed" required value="<?php echo $wallet->title; ?>" >
                            </div>
                        </div>
                        <div class="uk-width-large-1-3">
                            <div class="md-input-wrapper md-input-filled">
                                ...
                                <select name="localtion" class="uk-width-1-1" >
                                    <?php
                                        foreach($warehouses as $warehouse){
                                            ...
                                            if($warehouse->id == $wallet->location_id){
                                                echo 'selected';
                                            }
                                ...
                                <select name="users[]" class="uk-width-1-1 select2" multiple >
                                    <?php
                                        foreach($userslist as $user){
                                            ...
                                            foreach($wallet_users as $wu){
                                                if($user->id == $wu->user_id){
                                                    echo 'selected';
                                                }
                                            }
                        ...
                        <div class="uk-width-large-1-3">
                            <div class="md-input-wrapper md-input-filled">
                                ...
                                <select name="status" class="uk-width-1-1" >
                                    <option value="active" <?php if($wallet->status == "active"){ echo 'selected'; } ?> >Active</option>
                                    <option value="deactive" <?php if($wallet->status == "deactive"){ echo 'selected'; } ?> >Deactive</option>
                                </select>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
        ...
        $('#addFrom').submit(function(e){
            ...
            $.ajax({
                url: '<?php echo base_url('admin/system_settings/update_wallet'); ?>',
                type: 'POST',
