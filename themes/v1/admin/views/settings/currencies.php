    ...
    <div id="page_content_inner">
        <div class="md-card">
            <div class="md-card-toolbar">
                <h3 class="md-card-toolbar-heading-text">Currencies</h3>
    ...
    ?>
        <div class="uk-modal-dialog">
            <div class="uk-modal-header">
                <h3 class="uk-modal-title">Create Currency</h3>
            </div>
                ...
                <div class="uk-grid">
                    ...
                    <div class="uk-width-large-1-1">
                        <div class="md-input-wrapper md-input-filled">
                            ...
                            <input type="text" name="symbol" class="md-input md-input-success label-fixed" required >
                        </div>
                    </div>
                </div>
            </div>
...
<div class="uk-modal" id="modal_edit">
    ...
    ?>
        <div class="uk-modal-dialog">
            <div class="uk-modal-header">
                <h3 class="uk-modal-title">Edit Currencies</h3>
            </div>
            <div class="uk-modal-body">
                <div class="uk-grid">
                    <div class="uk-width-large-1-1">
                        <div class="md-input-wrapper md-input-filled">
                            ...
                            <input type="text" name="code" class="md-input md-input-success label-fixed" required id="code" >
                        </div>
                    </div>
                    <div class="uk-width-large-1-1">
                        <div class="md-input-wrapper md-input-filled">
                    ...
                    <div class="uk-width-large-1-1">
                        <div class="md-input-wrapper md-input-filled">
                            <label>Symbol <span class="red" >*</span></label>
                            <input type="text" name="symbol" class="md-input md-input-success label-fixed" required id="symbol" >
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    $.DataTableInit({
        ...
        dom: 'Blfrtip',
        url:"<?= admin_url('system_settings/get_currencies'); ?>",
        data:data,
        aaSorting: [[0, "desc"]],
        columnDefs: [
            { 
...
<script>
    $(document).ready(function(){
        ...
        $('#addFrom').submit(function(e){
            ...
            $.ajax({
                url: '<?php echo base_url('admin/system_settings/insert_currency'); ?>',
                type: 'POST',
        ...
        $('#editFrom').submit(function(e){
            ...
            $('#submitbtn').prop('disabled', true);
            $.ajax({
                url: '<?php echo base_url('admin/system_settings/update_currency'); ?>',
                type: 'POST',
                data: new FormData(this),
                contentType: false,
                cache: false,
        ...
        $(document).on('click','.deletebtn',function(){
            ...
            Swal.fire({
                ...
                if(res.isConfirmed){
                    Swal.fire({
                        title: 'Deleting Currency!',
                        showCancelButton: false,
                        didOpen: () => {
                            Swal.showLoading();
                            $.ajax({
                                url: '<?php echo base_url("admin/system_settings/delete_currency"); ?>',
                                type: 'POST',
