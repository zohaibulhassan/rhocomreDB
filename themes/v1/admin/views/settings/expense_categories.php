    ...
    <div id="page_content_inner">
        <div class="md-card">
            <div class="md-card-toolbar">
                <h3 class="md-card-toolbar-heading-text">Expense Categories</h3>
...
<script>
    ...
    $.DataTableInit({
        ...
        url:"<?= admin_url('system_settings/get_excategories'); ?>",
        data:data,
        aaSorting: [[0, "desc"]],
        columnDefs: [
            { 
...
<script>
    $(document).ready(function(){
        ...
        $('#addFrom').submit(function(e){
            ...
            $.ajax({
                url: '<?php echo base_url('admin/system_settings/insert_excategory'); ?>',
                type: 'POST',
        ...
        $('#editFrom').submit(function(e){
            ...
            $('#submitbtn').prop('disabled', true);
            $.ajax({
                url: '<?php echo base_url('admin/system_settings/update_excategory'); ?>',
                type: 'POST',
                data: new FormData(this),
                contentType: false,
                cache: false,
        ...
        $(document).on('click','.deletebtn',function(){
            ...
            Swal.fire({
                ...
                if(res.isConfirmed){
                    Swal.fire({
                        title: 'Deleting Expense Category!',
                        showCancelButton: false,
                        didOpen: () => {
                            Swal.showLoading();
                            $.ajax({
                                url: '<?php echo base_url("admin/system_settings/delete_excategory"); ?>',
                                type: 'POST',
