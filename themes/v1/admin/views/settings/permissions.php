                    ...
                    <table class="uk-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?= lang("Wallets"); ?></td>
                                <td class="text-center">
                                    <input type="checkbox" value="1" class="checkbox" name="wallet_view'" <?php echo $p->{'wallet_view'} ? "checked" : ''; ?>>
                                </td>
                                <td class="text-center">
                                    <input type="checkbox" value="1" class="checkbox" name="wallet_add" <?php echo $p->{'wallet_add'} ? "checked" : ''; ?>>
                                </td>
                                <td class="text-center">
                                    <input type="checkbox" value="1" class="checkbox" name="wallet_edit" <?php echo $p->{'wallet_edit'} ? "checked" : ''; ?>>
                                </td>
                                <td class="text-center">
                                    <input type="checkbox" value="1" class="checkbox" name="wallet_transations" <?php echo $p->{'wallet_transations'} ? "checked" : ''; ?>>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td colspan="5">
                                    <span>
                                        <input type="checkbox" value="1" class="checkbox" id="bulk_actions" name="bulk_actions" <?php echo $p->bulk_actions ? "checked" : ''; ?>>
                                        <label for="bulk_actions" class="padding05"><?= lang('bulk_actions') ?></label>
                                    </span>
                                    <span>
                                        <input type="checkbox" value="1" class="checkbox" id="edit_price" name="edit_price" <?php echo $p->edit_price ? "checked" : ''; ?>>
