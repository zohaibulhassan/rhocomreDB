    ...
    <div id="page_content_inner">
        <div class="md-card">
            <div class="md-card-toolbar">
                <h3 class="md-card-toolbar-heading-text">Units</h3>
    ...
    ?>
        <div class="uk-modal-dialog">
            <div class="uk-modal-header">
                <h3 class="uk-modal-title">Create Unit</h3>
            </div>
...
<div class="uk-modal" id="modal_edit">
    ...
    ?>
        <div class="uk-modal-dialog">
            <div class="uk-modal-header">
                <h3 class="uk-modal-title">Edit Unit</h3>
            </div>
            <div class="uk-modal-body">
                <div class="uk-grid">
                    <div class="uk-width-large-1-1">
...
<script>
    ...
    $.DataTableInit({
        ...
        url:"<?= admin_url('system_settings/get_units'); ?>",
        data:data,
        aaSorting: [[0, "desc"]],
        columnDefs: [
            { 
...
<script>
    $(document).ready(function(){
        ...
        $('#addFrom').submit(function(e){
            ...
            $.ajax({
                url: '<?php echo base_url('admin/system_settings/insert_unit'); ?>',
                type: 'POST',
        ...
        $('#editFrom').submit(function(e){
            ...
            $('#submitbtn').prop('disabled', true);
            $.ajax({
                url: '<?php echo base_url('admin/system_settings/update_unit'); ?>',
                type: 'POST',
                data: new FormData(this),
                contentType: false,
                cache: false,
        ...
        $(document).on('click','.deletebtn',function(){
            ...
            Swal.fire({
                ...
                if(res.isConfirmed){
                    Swal.fire({
                        title: 'Deleting Own Unit!',
                        showCancelButton: false,
                        didOpen: () => {
                            Swal.showLoading();
                            $.ajax({
                                url: '<?php echo base_url("admin/system_settings/delete_unit"); ?>',
                                type: 'POST',
