    ...
    <div id="page_content_inner">
        <div class="md-card">
            <div class="md-card-toolbar">
                <h3 class="md-card-toolbar-heading-text">Formula Forms</h3>
    ...
    ?>
        <div class="uk-modal-dialog">
            <div class="uk-modal-header">
                <h3 class="uk-modal-title">Create Form</h3>
            </div>
...
<div class="uk-modal" id="modal_edit">
    ...
    ?>
        <div class="uk-modal-dialog">
            <div class="uk-modal-header">
                <h3 class="uk-modal-title">Edit Form</h3>
            </div>
            <div class="uk-modal-body">
                <div class="uk-grid">
                    <div class="uk-width-large-1-1">
...
<script>
    ...
    $.DataTableInit({
        ...
        url:"<?= admin_url('products/get_forms'); ?>",
        data:data,
        aaSorting: [[1, "desc"]],
        columnDefs: [
            { 
...
<script>
    $(document).ready(function(){
        ...
        $('#addFrom').submit(function(e){
            ...
            $.ajax({
                url: '<?php echo base_url('admin/products/insert_form'); ?>',
                type: 'POST',
        ...
        $('#editFrom').submit(function(e){
            ...
            $('#submitbtn').prop('disabled', true);
            $.ajax({
                url: '<?php echo base_url('admin/products/update_form'); ?>',
                type: 'POST',
                data: new FormData(this),
                contentType: false,
                cache: false,
                ...
                if(res.isConfirmed){
                    Swal.fire({
                        ...
                        didOpen: () => {
                            Swal.showLoading();
                            $.ajax({
                                url: '<?php echo base_url("admin/products/delete_form"); ?>',
                                type: 'POST',
