    ...
    <div id="page_content_inner">
        <div class="md-card">
            <div class="md-card-toolbar">
                <h3 class="md-card-toolbar-heading-text">Formula Strengths</h3>
    ...
    ?>
        <div class="uk-modal-dialog">
            <div class="uk-modal-header">
                <h3 class="uk-modal-title">Create Strength</h3>
            </div>
...
<div class="uk-modal" id="modal_edit">
    ...
    ?>
        <div class="uk-modal-dialog">
            <div class="uk-modal-header">
                <h3 class="uk-modal-title">Edit Strength</h3>
            </div>
            <div class="uk-modal-body">
                <div class="uk-grid">
                    <div class="uk-width-large-1-1">
...
<script>
    ...
    $.DataTableInit({
        ...
        url:"<?= admin_url('products/get_strengths'); ?>",
        data:data,
        aaSorting: [[1, "desc"]],
        columnDefs: [
            { 
...
<script>
    $(document).ready(function(){
        ...
        $('#addFrom').submit(function(e){
            ...
            $.ajax({
                url: '<?php echo base_url('admin/products/insert_strength'); ?>',
                type: 'POST',
        ...
        $('#editFrom').submit(function(e){
            ...
            $('#submitbtn').prop('disabled', true);
            $.ajax({
                url: '<?php echo base_url('admin/products/update_strength'); ?>',
                type: 'POST',
                data: new FormData(this),
                contentType: false,
                cache: false,
        ...
        $(document).on('click','.deletebtn',function(){
            var id = $(this).data('id');
            Swal.fire({
                title: "Do you want to delete this strength",
                input: "text",
                ...
                if(res.isConfirmed){
                    Swal.fire({
                        title: 'Deleting strength!',
                        showCancelButton: false,
                        didOpen: () => {
                            Swal.showLoading();
                            $.ajax({
                                url: '<?php echo base_url("admin/products/delete_strength"); ?>',
                                type: 'POST',
