...
<div id="page_content">
    <div id="page_content_inner">
            ...
            <div class="md-card-content">
                <form action="<?php echo base_url('admin/reports/po_items_wise'); ?>" method="get">
                    ...
                    <div class="uk-grid">
                        ...
                        <div class="uk-width-large-1-5" style="padding-top: 20px;">
        ...
        <div class="md-card">
            <div class="md-card-toolbar">
                <h3 class="md-card-toolbar-heading-text">PO Items Wise Report</h3>
                <div class="md-card-toolbar-actions">
            ...
            <div class="md-card-content">
                ...
                <thead>
                        <tr>
                                ...
                                <th>Carton Size</th>
                                <th>Order Master Carton</th>
                                <th>Received Master Carton</th>
                                <th>Unreceived Master Carton</th>
                                <th>Create By</th>
                                <th>PO Status</th>
                                <th>Group ID</th>
                                <th>Group Name</th>
