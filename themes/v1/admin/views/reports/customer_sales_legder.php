    ...
    <div id="page_content_inner">
        <div class="md-card">
            ...
            <div class="md-card-content">
                <form action="<?php echo base_url('admin/reports/customer_legder'); ?>" method="get">
                    ...
                    <div class="uk-grid">
                        ...
                        <div class="uk-width-large-1-3">
                            <div class="md-input-wrapper md-input-filled">
                                ...
                                echo form_dropdown('supplier', $bl, $supplier, 'id="suppliers" data-placeholder="' . lang("select") . ' ' . lang("supplier") . '" required="required" class="form-control input-tip select" style="width:100%;"');
                                ?>
                            </div>
                        </div>
                        ...
                        <div class="uk-width-large-1-3">
                            <div class="md-input-wrapper md-input-filled">
                                ...
                                echo form_dropdown('customers', $bl, $customer, 'id="customers" data-placeholder="' . lang("select") . ' ' . lang("cuctomer") . '" required="required" class="form-control input-tip select" style="width:100%;"');
                                ?>
                            </div>
                        </div>
                        ...
                        <div class="uk-width-large-1-3">
                            <div class="md-input-wrapper md-input-filled">
                                ...
                                <input class="md-input  label-fixed" type="text" name="start_date" data-uk-datepicker="{format:'YYYY-MM-DD'}" autocomplete="off" value="<?php echo $start ?>" readonly>
                            </div>
                        </div>
                        <div class="uk-width-large-1-3">
                            <div class="md-input-wrapper md-input-filled">
                                <label>End Date</label>
                                <input class="md-input  label-fixed" type="text" name="end_date" data-uk-datepicker="{format:'YYYY-MM-DD'}" autocomplete="off" value="<?php echo $end ?>" readonly>
                            </div>
                        </div>
        ...
        <div class="md-card">
            <div class="md-card-toolbar">
                <h3 class="md-card-toolbar-heading-text">Customer Sales Legder</h3>
                <div class="md-card-toolbar-actions">
