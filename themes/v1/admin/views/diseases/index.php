    ...
    <div id="page_content_inner">
        <div class="md-card">
            <div class="md-card-toolbar">
                <h3 class="md-card-toolbar-heading-text">Diseases</h3>
    ...
    ?>
        <div class="uk-modal-dialog">
            <div class="uk-modal-header">
                <h3 class="uk-modal-title">Create Disease</h3>
            </div>
            <div class="uk-modal-body">
                <div class="uk-grid">
                    ...
                    <div class="uk-width-large-1-1">
                        <textarea name="description" class="md-input no_autosize" id="editor" style="min-height:250px" ></textarea>
                    </div>
                </div>
            </div>
...
<div class="uk-modal" id="modal_edit">
    ...
    ?>
        <div class="uk-modal-dialog">
            <div class="uk-modal-header">
                <h3 class="uk-modal-title">Edit Disease</h3>
            </div>
            <div class="uk-modal-body">
                <div class="uk-grid">
                    <div class="uk-width-large-1-1">
                    ...
                    <div class="uk-width-large-1-1">
                        <textarea name="description" class="md-input no_autosize" id="description" style="min-height:250px" ></textarea>
                    </div>
                </div>
            </div>
            <div class="uk-modal-footer uk-text-right">
...
<script>
    ...
    $.DataTableInit({
        ...
        url:"<?= admin_url('diseases/get_diseases'); ?>",
        data:data,
        aaSorting: [[1, "desc"]],
        columnDefs: [
            { 
...
<script>
    $(document).ready(function(){
        ...
        $('#addFrom').submit(function(e){
            ...
            $.ajax({
                url: '<?php echo base_url('admin/diseases/insert_disease'); ?>',
                type: 'POST',
        ...
        $('#editFrom').submit(function(e){
            ...
            $('#submitbtn').prop('disabled', true);
            $.ajax({
                url: '<?php echo base_url('admin/diseases/update_disease'); ?>',
                type: 'POST',
                data: new FormData(this),
                contentType: false,
                cache: false,
                ...
                if(res.isConfirmed){
                    Swal.fire({
                        ...
                        didOpen: () => {
                            Swal.showLoading();
                            $.ajax({
                                url: '<?php echo base_url("admin/diseases/delete_disease"); ?>',
                                type: 'POST',
