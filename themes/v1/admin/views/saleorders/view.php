                        ...
                        <div class="uk-dropdown uk-dropdown-small">
                            <ul class="uk-nav">
                                <?php if ($so->status == "partial" || $so->status == "pending") { ?>
                                    ...
                                    <?php } ?>
                                    <li><a href="<?php echo base_url('admin/salesorders/create/' . $so->id); ?>"><i
                                                class="fa-solid fa-file-invoice"></i> Create Invoice</a></li>

                                    <?php if ($Owner || $Admin || $GP['so_edit_info']) { ?>
                                    <?php } ?>

                                    <li><a href="#" id="SOdetailbtn"><i class="fa-solid fa-pen-to-square"></i> Edit SO
                                            Detial</a></li>
                                    ...
                                    <?php if (($Owner || $Admin || $GP['so_cancel']) && $so->operation_team_stauts == "pending") { ?>
                                        <li><a href="#" id="cancelSOBtn"><i class="fa-solid fa-ban"></i> Cancel Sale Order</a>
                                        </li>
                                    <?php } ?>
            ...
            <div class="md-card-content">
                <div class="uk-grid" data-uk-grid-margin>
                    <div class="uk-width-large-1-3">
                        <div class="uk-margin-bottom">
                            ...
                            <address>
                                <p><strong>
                                        <?php echo $so->cusomer_company ?>
                                    </strong></p>
                                <p>
                                    <?php echo $so->cusomer_address ?>
                                </p>
                                <p>
                                    <?php echo $so->cusomer_city . ', ' . $so->cusomer_state . ', ' . $so->cusomer_country ?>
                                </p>
                                <p><b>Phone:</b>
                                    <?php echo $so->cusomer_phone ?>
                                </p>
                                <p><b>Email:</b>
                                    <?php echo $so->cusomer_email ?>
                                </p>
                                <?php
                                if ($so->cusomer_cnic != "") {
                    ...
                    <div class="uk-width-large-1-3">
                        <div class="uk-margin-bottom">
                            ...
                            <address>
                                <p><strong>
                                        <?php echo $so->supplier_company ?>
                                    </strong></p>
                                <p>
                                    <?php echo $so->supplier_address ?>
                                </p>
                                <p>
                                    <?php echo $so->supplier_city . ', ' . $so->supplier_state . ', ' . $so->supplier_country ?>
                                </p>
                                <p><b>Phone:</b>
                                    <?php echo $so->supplier_phone ?>
                                </p>
                                <p><b>Email:</b>
                                    <?php echo $so->supplier_email ?>
                                </p>
                                <?php
                                if ($so->supplier_cnic != "") {
                    ...
                    <div class="uk-width-large-1-3">
                        <div class="uk-margin-bottom">
                            ...
                            <address>
                                ...
                                <p><b>Warehouse:</b>
                                    <?php echo $so->warehouse_name ?>
                                </p>
                                <p><b>PO Number:</b>
                                    <?php echo $so->po_number ?>
                                </p>
                                <p><b>PO Date:</b>
                                    <?php echo $so->po_date ?>
                                </p>
                                <p><b>Phone:</b>
                                    <?php echo $so->payment_status ?>
                                </p>
                                <!-- <p><b>Create Date:</b> <?php echo $so->created_at ?></p>
                                <p><b>Created By:</b> <?php echo $so->created_by ?></p> -->
                                <p><b>Complete/Closing Date:</b>
                                    <?php echo $so->complete_date ?>
                                </p>
                                <p><b>Cancel Date:</b>
                                    <?php echo $so->cancel_date ?>
                                </p>
                                <p><b>Account Status:</b>
                                    <?php echo $so->accounts_team_status ?>
                                </p>
                                <p><b>Operation Status:</b>
                                    <?php echo $so->operation_team_stauts ?>
                                </p>
                                <p><b>Status:</b>
                                    <?php echo $so->status ?>
                                </p>
                ...
                <table id="itemsTable" class="uk-table">
                    ...
                    <tfoot>
                        ...
                        <th>
                            <?= $this->sma->formatMoney2($total_value) ?>
                        </th>
                        <th>
                            <?= $total_cqty ?>
                        </th>
                        <th>
                            <?= $this->sma->formatMoney2($total_cvalue) ?>
                        </th>
                        <th colspan="1">
                            <?php
                            if ($total_qty == $total_cqty) {
                                ...
                                echo round(((($total_eqty) / $total_qty) * 100), 0);
                                echo '%';
                            }
                            ?>
                        </th>
                        <th>
                            <?= $total_qty - $total_cqty ?>
                        </th>
                        <th>
                            <?= $this->sma->formatMoney2($total_value - $total_cvalue) ?>
                        </th>
                        <th colspan="1">
                            <?php
                            $totalcompleteper = ($total_cqty / $total_qty) * 100;
                            echo round($totalcompleteper, 0);
                            ?>%
                        </th>
                        <th>
                            <?php
                        ...
                        <th colspan="1">
                            ...
                            if ($total_qty == $total_cqty) {
                                ...
                                echo round(((($total_groupskueqty) / $total_qty) * 100), 0);
                                echo '%';
                            }
                            ?>
                        </th>
            ...
            <div class="uk-grid">
                <div class="uk-width-large-1-1">
                    <div class="md-input-wrapper md-input-filled">
                        ...
                        <input type="text" name="qty" id="editItemQtyTxt"
                            class="md-input md-input-success label-fixed itemqty" required>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="uk-grid">
                <div class="uk-width-large-1-2">
                    <div class="md-input-wrapper md-input-filled">
                        ...
                        <input class="md-input  label-fixed" type="text" name="date"
                            ...
                            value="<?php echo $so->date; ?>" readonly required>
                    </div>
                </div>
                <div class="uk-width-large-1-2">
                    <div class="md-input-wrapper md-input-filled">
                        ...
                        <select name="customer" class="uk-width-1-1 select2" required id="customer_select"
                            style="width:100%;">
                            <option value="<?php echo $so->cusomer_id; ?>">
                                <?php echo $so->cusomer_name; ?>
                            </option>
                        </select>
                    </div>
                </div>
                <div class="uk-width-large-1-2">
                    <div class="md-input-wrapper md-input-filled">
                        ...
                        <input type="text" name="ponumber" class="md-input md-input-success label-fixed" required
                            value="<?php echo $so->po_number; ?>">
                    </div>
                </div>
                <div class="uk-width-large-1-2">
                    <div class="md-input-wrapper md-input-filled">
                        <label>PO Date</label>
                        <input class="md-input  label-fixed" type="text" name="po_date"
                            data-uk-datepicker="{format:'YYYY-MM-DD'}" autocomplete="off"
                            value="<?php echo $so->po_date; ?>" readonly required>
                    </div>
                </div>
                <div class="uk-width-large-1-2">
                    <div class="md-input-wrapper md-input-filled">
                        <label>Delivery Date</label>
                        <input class="md-input  label-fixed" type="text" name="saledeliverydate"
                            data-uk-datepicker="{format:'YYYY-MM-DD'}" autocomplete="off"
                            value="<?php echo $so->delivery_date; ?>" readonly required>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="uk-grid">
                ...
                <div class="uk-width-large-1-2">
                    <div class="md-input-wrapper md-input-filled">
                        ...
                        <input type="number" name="qty" class="md-input md-input-success label-fixed" required value="0"
                            id="sobatchqty">
                ...
                <div class="uk-width-large-1-2">
                    <div class="md-input-wrapper md-input-filled">
                        ...
                        <input type="number" name="uncompleteqty" class="md-input md-input-success label-fixed" required
                            value="0" id="uncompleteqtyTxt" readonly>
                    </div>
                </div>
