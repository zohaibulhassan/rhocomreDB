    ...
    <div id="page_content_inner">
        <div class="md-card">
            <div class="md-card-toolbar">
                <h3 class="md-card-toolbar-heading-text">Stock Infor</h3>
...
<div class="md-fab-wrapper md-fab-in-card" style="position: fixed;bottom: 20px;">
    <a class="md-fab md-fab-success md-fab-wave waves-effect waves-button" href="<?php echo base_url('admin/customers/add'); ?>"><i class="fa-solid fa-plus"></i></a>
</div>
<!-- datatables -->
...
<script>
    ...
    $.DataTableInit({
        ...
        url:"<?= admin_url('customers/get_stockinfodetail'); ?>",
        data:data,
        aaSorting: [[0, "desc"]],
    });
</script>
