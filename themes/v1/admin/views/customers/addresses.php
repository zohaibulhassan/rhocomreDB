    ...
    <div id="page_content_inner">
        <div class="md-card">
            <div class="md-card-toolbar">
                <h3 class="md-card-toolbar-heading-text">Addresses</h3>
    ...
    ?>
        <div class="uk-modal-dialog">
            <div class="uk-modal-header">
                <h3 class="uk-modal-title">Add Address</h3>
            </div>
                ...
                <div class="uk-grid">
                    <div class="uk-width-large-1-1">
                        <div class="md-input-wrapper md-input-filled">
                            ...
                            <input type="text" name="line1" class="md-input md-input-success label-fixed" required >
                        </div>
                    </div>
                    <div class="uk-width-large-1-1">
                        <div class="md-input-wrapper md-input-filled">
                            <label>Address 2 <span class="red" >*</span></label>
                            <input type="text" name="line2" class="md-input md-input-success label-fixed" required >
                        </div>
                    </div>
                    <div class="uk-width-large-1-1">
                        <div class="md-input-wrapper md-input-filled">
                    ...
                    <div class="uk-width-large-1-1">
                        <div class="md-input-wrapper md-input-filled">
                            ...
                            <input type="text" name="postal_code" class="md-input md-input-success label-fixed" required >
                        </div>
                    </div>
                    <div class="uk-width-large-1-1">
                        <div class="md-input-wrapper md-input-filled">
            ...
            <div class="uk-modal-body">
                ...
                <div class="uk-width-large-1-1">
                        <div class="md-input-wrapper md-input-filled">
                            ...
                            <input type="text" name="line1" class="md-input md-input-success label-fixed" required id="line1">
                        </div>
                    </div>
                    <div class="uk-width-large-1-1">
                        <div class="md-input-wrapper md-input-filled">
                            <label>Address 2 <span class="red" >*</span></label>
                            <input type="text" name="line2" class="md-input md-input-success label-fixed" required id="line2">
                        </div>
                    </div>
                    <div class="uk-width-large-1-1">
                        <div class="md-input-wrapper md-input-filled">
                            <label>Phone <span class="red" >*</span></label>
                            <input type="text" name="phone" class="md-input md-input-success label-fixed" required id="phone">
                        </div>
                    </div>
                    <div class="uk-width-large-1-1">
                        <div class="md-input-wrapper md-input-filled">
                            <label>Postal Code <span class="red" >*</span></label>
                            <input type="text" name="postal_code" class="md-input md-input-success label-fixed" required id="postal_code">
                        </div>
                    </div>
                    <div class="uk-width-large-1-1">
                        <div class="md-input-wrapper md-input-filled">
                            <label>City <span class="red" >*</span></label>
                            <input type="text" name="city" class="md-input md-input-success label-fixed" required id="city">
                        </div>
                    </div>
                    <div class="uk-width-large-1-1">
                        <div class="md-input-wrapper md-input-filled">
                            <label>State <span class="red" >*</span></label>
                            <input type="text" name="state" class="md-input md-input-success label-fixed" required id="state">
                        </div>
                    </div>
                    <div class="uk-width-large-1-1">
                        <div class="md-input-wrapper md-input-filled">
                            <label>Country <span class="red" >*</span></label>
                            <input type="text" name="country" class="md-input md-input-success label-fixed" required id="country">
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    $.DataTableInit({
        ...
        url:"<?= admin_url('customers/get_addresses'); ?>",
        data:data,
        aaSorting: [[0, "desc"]],
        columnDefs: [
            { 
...
<script>
    $(document).ready(function(){
        ...
        $('#addFrom').submit(function(e){
            ...
            $.ajax({
                url: '<?php echo base_url('admin/customers/insert_address'); ?>',
                type: 'POST',
        ...
        $('#editFrom').submit(function(e){
            ...
            $('#submitbtn').prop('disabled', true);
            $.ajax({
                url: '<?php echo base_url('admin/customers/update_address'); ?>',
                type: 'POST',
                data: new FormData(this),
                contentType: false,
                cache: false,
                ...
                if(res.isConfirmed){
                    Swal.fire({
                        ...
                        didOpen: () => {
                            Swal.showLoading();
                            $.ajax({
                                url: '<?php echo base_url("admin/customers/delete_address"); ?>',
                                type: 'POST',
