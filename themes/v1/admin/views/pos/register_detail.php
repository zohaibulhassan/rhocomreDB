    ...
    <table width="100%" class="uk-table registertable">
        ...
        <tr>
            ...
            <td style="text-align:right;"><h4>
                <span><strong><?= $cashsales->paid ? $this->sma->formatMoney(($cashsales->paid + ($cash_in_hand)) + ($refunds->returned ? $refunds->returned : 0) - (0) - $expense) : $this->sma->formatMoney($cash_in_hand - $expense - (0)); ?></strong></span>
            </h4></td>
        </tr>
    </table>
