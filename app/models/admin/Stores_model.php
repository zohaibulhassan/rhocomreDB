...
class Stores_model extends CI_Model
{
    ...
    public function products($store_id){
        ...
        $this->db->select("
            ...
            sma_bulk_discount.discount_name,
            sma_bulk_discount.discount_code,
        ...
        $this->db->join('sma_bulk_discount', 'sma_bulk_discount.id = store_products_tb.discount', 'left');
        ...
        foreach($products as $product){
            ...
            if($product->discount == "no"){
                ...
                $setdata->discountname = $product->discount_name;
            }
