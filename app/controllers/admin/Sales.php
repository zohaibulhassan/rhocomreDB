...
class Sales extends MY_Controller
{
    ...
    public function index()
    {
        ...
        $this->data['dispatches'] = $this->general_model->GetAllDispatchers();
    ...
    public function get_lists()
    {
        ...
        foreach ($rows as $row) {
            ...
            $button .= "mode:'click',pos:'bottom-left'";
            $button .= '}" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="uk-dropdown uk-dropdown-bottom" aria-hidden="true" style="min-width: 200px; top: 35px; left: 0px;" tabindex="">
                    ...
                    ';
            $button .= '<li><a href="' . base_url('admin/sales/detail/' . $row->id) . '">' . lang('sale_details') . '</a></li>';
            // $button .= '<li><a href="' . base_url('admin/sales/add?sale_id=' . $row->id) . '">'.lang('duplicate_sale').'</a></li>';
            // $button .= '<li><a href="' . base_url('admin/sales/payments/' . $row->id) . '">' . lang('view_payments') . '</a></li>';
            $button .= '<li><a href="' . base_url('admin/sales/add_payment/' . $row->id) . '">' . lang('add_payment') . '</a></li>';
            // $button .= '<li><a href="' . base_url('admin/sales/packaging/' . $row->id) . '">'.lang('packaging').'</a></li>';
            // $button .= '<li><a href="' . base_url('admin/sales/add_delivery/' . $row->id) . '">'.lang('add_delivery').'</a></li>';
            // $button .= '<li><a href="' . base_url('admin/sales/email/' . $row->id) . '">'.lang('email_sale').'</a></li>';
            if ($row->delivery_status == "pending") {
                if ($row->no_deliver == 0 || $row->no_deliver == "") {
                    $button .= '<button class="md-btn md-btn-warning md-btn-wave-light waves-effect waves-button waves-light md-btn-mini dispatcheBtn" data-id="' . $row->id . '" >Assign Dispatche</button>';
                }
            }
            $button .= '<li><a href="' . base_url('admin/sales/pdf/' . $row->id) . '">' . lang('download_pdf') . '</a></li>';
            $button .= '<li><a href="' . base_url('admin/sales/Delivery_challan/' . $row->id) . '">Delivery Challan</a></li>';
            $button .= '<li><a href="' . base_url('admin/sales/Delivery_challan2/' . $row->id) . '">Delivery Challan New</a></li>';
            $button .= '<li><a href="' . base_url('admin/sales/salestaxpdf1/' . $row->id) . '">Sales Tax Invoice 1</a></li>';
            $button .= '<li><a href="' . base_url('admin/sales/salestaxpdf2/' . $row->id) . '">Sales Tax Invoice 2</a></li>';
            $button .= '<li><a href="' . base_url('admin/sales/salestaxpdf3/' . $row->id) . '">Sales Tax Invoice 3</a></li>';
            $button .= '<li><a href="' . base_url('admin/sales/bill_with_one_and_two_discount_pdf/' . $row->id) . '">Download Bill With 2 Discount</a></li>';
            $button .= '<li><a href="' . base_url('admin/sales/bill_with_one_two_and_three_discount_pdf/' . $row->id) . '">Download Bill With 3 Discount</a></li>';
            $button .= '<li><a href="' . base_url('admin/sales/bill_trading/' . $row->id) . '">Billing (new Trading)</a></li>';
            $button .= '<li><a href="' . base_url('admin/sales/return_sale/' . $row->id) . '">' . lang('return_sale') . '</a></li>';
            $button .= '<li><a href="#" class="stiPDF" data-id="' . $row->id . '" >Sales Tax Invoice 1(new)</a></li>';
            $button .= '<li><a href="#" class="stiPDF2" data-id="' . $row->id . '" >Sales Tax Invoice 1(new Trading)</a></li>';
            $button .= '<li><a href="#" class="sti2PDF" data-id="' . $row->id . '" >Sales Tax Invoice 2</a></li>';
            $button .= '<li><a href="#" class="sti2PDF2" data-id="' . $row->id . '" >Sales Tax Invoice 2 New</a></li>';
            if ($this->Owner) {
                $button .= '<li><a href="#" class="deletebtn" data-id="' . $row->id . '" >' . lang('delete_sale') . '</a></li>';
            }
            $button .= '
                    </ul>
                </div>
        ...
        if ($onlycoun == 'yes') {
            ...
            $this->db->select('
                ...
                (
                    SELECT
                        COUNT(sd.id)
                    FROM sma_sales_dispatch as sd 
                    WHERE
                        sd.sale_id = sales.id AND
                        sd.status = "pending"
                ) as no_deliver,
    ...
    public function salepayments()
    {
        ...
        $bc = [['link' => base_url(), 'page' => lang('home')], ['link' => '#', 'page' => lang('sales')]];
        $meta = ['page_title' => lang('sales'), 'bc' => $bc];
        $this->page_construct2('sales/payments', $meta, $this->data);
    }

    public function get_listspayments()
    {
        // Count Total Rows
        $this->db->from('sales');
        $totalq = $this->db->get();
        $this->runquery_salespayments('yes');
        $query = $this->db->get();
        $recordsFiltered = $query->num_rows();
        $this->runquery_salespayments();
        if ($_POST['length'] != -1) {
            $this->db->limit($_POST['length'], $_POST['start']);
        }
        $query = $this->db->get();
...
//             $button .= '
//     <button class="md-btn md-btn-primary md-btn-mini paymentBtn" data-uk-modal="{target:\'#payment-modal-' . $row->id . '\'}">Add Payment</button>
//     <div id="payment-modal-' . $row->id . '" class="uk-modal">
      
//     </div>
// ';

$button .= '<button class="md-btn md-btn-primary md-btn-wave-light waves-effect waves-button waves-light md-btn-mini payment-modal" data-id="' . $row->id . '" >Payments</button>';
            ...
            //         <ul class="uk-nav uk-nav-dropdown">
            //         ';
            $button .= '<li><a class="md-btn md-btn-secondary md-btn-wave-light waves-effect waves-button waves-light md-btn-mini" href="' . base_url('admin/sales/detail/' . $row->id) . '">' . lang('sale_details') . '</a></li>';
            // $button .= '<li><a href="' . base_url('admin/sales/add?sale_id=' . $row->id) . '">'.lang('duplicate_sale').'</a></li>';
            // $button .= '<li><a href="' . base_url('admin/sales/payments/' . $row->id) . '">' . lang('view_payments') . '</a></li>';
            // $button .= '<button class="md-btn md-btn-primary md-btn-wave-light waves-effect waves-button waves-light md-btn-mini paymentBtn" data-id="' . $row->id . '" >Add Payment</button>';
            // $button .= '<li><a href="' . base_url('admin/sales/packaging/' . $row->id) . '">'.lang('packaging').'</a></li>';
            // $button .= '<li><a href="' . base_url('admin/sales/add_delivery/' . $row->id) . '">'.lang('add_delivery').'</a></li>';
            // $button .= '<li><a href="' . base_url('admin/sales/email/' . $row->id) . '">'.lang('email_sale').'</a></li>';
            // if ($row->delivery_status == "pending") {
    ...
    public function runquery_salespayments($onlycoun = 'no')
    {
        $id = $this->input->post('id');
        $column_search = [
            'sales.date',
    ...
    public function detail($id = null)
    {
        if ($id != '') {
            ...
            $meta = ['page_title' => 'Invoice No: ' . $inv->reference_no . ' ' . lang('view_sales_details'), 'bc' => $bc];
    ...
    public function opened()
    {
        ...
        $bc = [['link' => base_url(), 'page' => lang('home')], ['link' => '#', 'page' => lang('Open Sales')]];
        $meta = ['page_title' => lang('Open Sales'), 'bc' => $bc];
    ...
    public function itemdelete()
    {
        ...
        if ($reason != '') {
            ...
            if ($q->num_rows() > 0) {
                ...
                if ($q2->num_rows() > 0) {
                    $q2r = $q2->result()[0];
                    $this->db->delete('sma_sale_items', ['id' => $id]);
        ...
        if ($reason != '') {
            ...
            if ($q->num_rows() > 0) {
                ...
                foreach ($items as $item) {
                    ...
                    if ($q2->num_rows() > 0) {
                        $q2r = $q2->result()[0];
                        $this->db->delete('sma_sale_items', ['id' => $item->id]);
                ...
                $this->db->delete('sma_sales', ['id' => $id]);
                ...
                foreach ($srs as $sr) {
                    $this->db->delete('sma_sale_returns_tb', ['id' => $sr->id]);
                    $this->db->delete('sma_sale_return_items_tb', ['sale_return_id' => $sr->id]);
                }
    ...
    public function return_sale($id = null)
    {
        if ($id != '') {
            ...
            $bc = [['link' => base_url(), 'page' => lang('home')], ['link' => '#', 'page' => 'Sale Return']];
            $meta = ['page_title' => 'Sale Return', 'bc' => $bc];
        ...
        if ($sq->num_rows() > 0) {
            ...
            foreach ($sale_item_id as $key => $value) {
                if ($rqty[$key] > 0 && $reason[$key] == '') {
                    exit('Enter Reason');
                    exit;
                } elseif ($rqty[$key] == 0 && $reason[$key] != '') {
                    exit('Enter Return Quantity');
                    exit;
                } else {
                    if ($rqty[$key] > 0 && $reason[$key] != '') {
                        $this->db->select('*');
            ...
            if (count($returnitems) > 0) {
                ...
                if ($refund == 'yes') {
                    $payment = [
                        ...
                        'cc_year' => '',
                        'cc_type' => '',
                        'note' => 'Return Sale Refund Payment',
                        'created_by' => $this->session->userdata('user_id'),
                        'type' => 'received',
                        'status' => '',
                        'cpr_no' => '',
    ...
    public function returndelete()
    {
        ...
        if ($reason != '') {
            ...
            foreach ($finaldata as $row) {
                $this->db->delete('sma_sale_return_items_tb', ['id' => $row['riid']]);
                $this->updateQty($row['pid'], $row['wid'], $row['iid'], $row['qty'], '-');
            }
            if (count($finaldata) > 0) {
                $this->db->delete('sma_sale_returns_tb', ['id' => $id]);
