...
class Paymentcollections extends App_Controller{
    ...
    public function create(){
        ...
        if($sale_id != "" && $customer_id != "" && $paid_by != "" &&  $amount != "" &&  $created_by != ""){
    ...
    public function lists(){
        ...
        if($user_id != ""){
            $this->db->where('pc.created_by',$user_id);
        }
        $q = $this->db->get();
    ...
    public function details(){
        ...
        $this->db->join('sales as s','s.id = pc.sale_id','left');
        $this->db->join('users as u','u.id = pc.created_by','left');
        $this->db->join('sma_companies as c','c.id = pc.customer_id','left');
        $q = $this->db->get();
         $this->data['rows'] = $q->row();
         $this->data['code_status'] = true;
        $this->data['message'] = "Success!";
        }else{
             $this->data['rows'] = [];
